...
import { getCookie, removeCookie } from "../util/cookieUtil"; // cookie utility import
...
const Header = () => {
  ...
  const handleLoginSuccess = (token) => {
    ...
    cookies.set('member', token); // 쿠키에 member 값을 설정
        ...
        <Dropdown isOpen={dropdownOpen} toggle={toggleDropdown}>
          ...
          <DropdownMenu>
            ...
            {isLogin ? (
              ...
              <>
                <DropdownItem onClick={handleClickLogin}>로그인</DropdownItem>
                <DropdownItem onClick={handleClickRegister}>회원가입</DropdownItem>
              </>
            )}
          </DropdownMenu>
        </Dropdown>
